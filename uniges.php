...
$lineaId = 3; // ID fijo para Uniges-3
...
<body class="linea-uniges">
    <div class="app-simple">
        <div class="header-simple">
            <div class="header-title-logo">
                <img src="assets/images/logos/logo-uniges.png" alt="Logo <?php echo $lineaNombre; ?>" class="header-logo">
        ...
        <div class="nav-simple">
            ...
            <a href="uniges.php" class="active">Uniges-3</a>
        ...
        <div class="filter-sort-container">
            <form action="" method="GET" class="filter-form">
                ...
                <a href="uniges.php" class="btn btn-secondary">Limpiar</a>
                ...
                <thead>
                    <tr>
                        ...
                        function getSortLink($currentSortBy, $currentSortDir, $nextSortDir, $columnName, $columnLabel) {
                            $link = "uniges.php?sort=$columnName";
                            $icon = "";
                            $class = "sort-header";
