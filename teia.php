...
<body class="linea-teia">
    <div class="app-simple">
        <div class="header-simple">
            <div class="header-title-logo">
                <img src="assets/images/logos/logo-teia.jpg" alt="Logo <?php echo $lineaNombre; ?>" class="header-logo">
        ...
        <div class="nav-simple">
            ...
            <a href="teia.php" class="active">Teiá</a>
        </div>
        ...
        <div class="filter-sort-container">
            <form action="" method="GET" class="filter-form">
                ...
                <a href="teia.php" class="btn btn-secondary">Limpiar</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="status-feedback-wrapper">
                                    <div class="estado-selector" data-publicacion-id="<?php echo $publicacion['id']; ?>">
                                    ...
                                    <?php endif; ?>
                                </div> <!-- Cierre de status-feedback-wrapper -->
                            </td>
                            <td>
    ...
    <script>
        ...
        function cambiarEstado(opcionElement) {
            ...
            const publicacionId = selector.dataset.publicacionId;
