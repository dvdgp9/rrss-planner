...
<body class="linea-cubofit">
    <div class="app-simple">
        <div class="header-simple">
            <div class="header-title-logo">
                <img src="assets/images/logos/logo-cubofit.png" alt="Logo <?php echo $lineaNombre; ?>" class="header-logo">
        ...
        <div class="filter-sort-container">
            <form action="" method="GET" class="filter-form">
                ...
                <a href="cubofit.php" class="btn btn-secondary">Limpiar</a>
                <!-- Mantener ordenación actual al filtrar -->
                <?php if ($sort_by !== 'fecha_programada' || $sort_dir !== 'ASC'): ?>
                ...
                <thead>
                    <tr>
                        ...
                        function getSortLink($currentSortBy, $currentSortDir, $nextSortDir, $columnName, $columnLabel) {
                            $link = "cubofit.php?sort=$columnName";
                            $icon = "";
                            $class = "sort-header";
    ...
    <!-- Modal Compartir (misma estructura que en ebone.php) -->
